...
df = pd.read_csv("../Phase1_Model_Creation/final_dataset_with_skill_clusters.csv")
...
for job in predicted_jobs:
    ...
    model_path = f"../Phase1_Model_Creation/cluster_specialisers/cluster_specialiser_{cluster_id}.pt"
    encoder_path = f"../Phase1_Model_Creation/cluster_specialisers/job_label_encoder_{cluster_id}.pkl"
