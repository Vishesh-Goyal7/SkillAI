...
Now, write a passionate, convincing explanation in about 6-7 lines that makes the user believe they are the only one capable of this role. Use dark human psychology and manipulation tactics. Make them feel like their life's past experiences were building them to fulfill this role. Involve their current skills and tell how they contribute towards this particular role. Be specific and avoid clichés. Try to keep the use of terms that refer to destiny to a minimum to make sure that the predictions sound like coming from a career consultant and not an astrologer. 
